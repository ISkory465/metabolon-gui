...
class Window(QWidget):
    ...
    def updateOPCList(self):
        ...
        if x == 0:
          ...
          d1={'HE11.Hand':opcPrefix+'DB5.HE11.BF2','HE11.AUTO':opcPrefix+'DB5.HE11.BF3','HE11.AUS':opcPrefix+'DB5.HE11.BF4',
    ...
    def reportProgress(self,tagValues:dict):
        ...
        #  print(str(e))
          ...
          #mbox=QMessageBox.information(self,"Information ",str(e))
