...
#     def __init__(self, name, opcID='None', buttonSymbol=2, dec_num=None):
#         super().__init__()
#         self.instances.append(self)
#         # self.setFlat(True)
#         self.opcName = name
#         self.state = False
#         self.layout = QVBoxLayout()
#         self.layout.setAlignment(Qt.AlignTop)  # Align contents of QVBoxLayout at the top
#         self.layout.setSpacing(0)  # Set the spacing between widgets to 0
#         self.layout.setContentsMargins(0, 0, 0, 0)  # Set the margins around the layout to 0
#         self.setLayout(self.layout)
