...
from ..test_element import InfoField, ToggleButton, Futter1, Feststoffbtn
...
class Page():
  ...
  def UI(self,window:QMainWindow):
    ...
    #hbox1
      ...
      self.futter2 = Futter1(buttonName="DB60.FES2.VW.FES", sollwert11='Feststoff Sollwert [l/d]', solwert12='Feststoff Istwert [l/d]',  solwert21='Feststoff Sollwert [l/Zyklus]', solwert22='Feststoff Istwert [l/Zyklus]', layout=self.vbox1)
      self.futter3 = Futter1(buttonName="DB60.FES2.VW.FES", sollwert11='Maische Sollwert [l/d]',   solwert12='Maische Istwert [l/d]',    solwert21='Maische Sollwert [l/Zyklus]',   solwert22='Maische Istwert [l/Zyklus]', layout=self.vbox1)
      self.futterungszyKlein = InfoField(name ='Futterungszyklein/Tag', layout = self.vbox2)
      self.b50Flusw = InfoField(name ='DB50.MAILFLU1.FLUSW', layout = self.vbox3)
      self.db50Fluw = InfoField(name ='DB50.MAILFLU1.FLUW', layout =self.vbox3)
