...
class Page():
    ...
    def UI(self,window:QMainWindow):
        ...
        self.hbox2.addWidget(self.tankIbc.get_widget(), 0, 0)  # Add the tank widget to the grid layout
        self.hbox2.setColumnStretch(0, 0)
        
        # Create and add the Box widget
        self.box1 = Box("PU12")
        self.hbox2.addWidget(self.box1, 0, 6)  # Add the box widget to the grid layout
