...
class BigMixer(QWidget):
    ...
    def initUI(self):
        ...
        circle = CircleWidget()
        circle.setGeometry(200, 400, 60, 60)  # Set the position and size of the button using absolute positioning
        circle.setParent(self)  # Set the widget as the parent of the button
